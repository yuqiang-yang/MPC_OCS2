...
class Jacobians {
    public:
        ...
        class Type_fr_base_link_ur5e_J_fr_ee_link : public JacobianT<Scalar, 6, Type_fr_base_link_ur5e_J_fr_ee_link>
        {
        public:
            EIGEN_MAKE_ALIGNED_OPERATOR_NEW
            Type_fr_base_link_ur5e_J_fr_ee_link();
            const Type_fr_base_link_ur5e_J_fr_ee_link& update(const JState&);
        protected:
        };
    ...
    public:
        ...
        Type_fr_base_link_ur5e_J_fr_ee_link fr_base_link_ur5e_J_fr_ee_link;
