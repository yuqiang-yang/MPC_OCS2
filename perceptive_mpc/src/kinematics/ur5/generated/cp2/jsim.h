#ifndef IIT_UR5E_JSIM_H_
#define IIT_UR5E_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot ur5e.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::ur5e::tpl::JointState<typename TRAIT::Scalar>, 12, 12, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::ur5e::tpl::JointState<typename TRAIT::Scalar>, 12, 12, JSIM<TRAIT>> Base;
    public:
        ...
        typedef iit::ur5e::tpl::ForceTransforms<TRAIT> FTransforms;
