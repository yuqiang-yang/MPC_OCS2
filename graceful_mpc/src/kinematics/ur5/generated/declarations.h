#ifndef IIT_ROBOT_UR5E_DECLARATIONS_H_
#define IIT_ROBOT_UR5E_DECLARATIONS_H_
...
static const LinkIdentifiers orderedLinkIDs[linksCount] =
    {BASE_LINK_UR5E,SHOULDER_LINK,UPPER_ARM_LINK,FOREARM_LINK,WRIST_1_LINK,WRIST_2_LINK,WRIST_3_LINK};
