...
class SingleMarkerBroadcaster:
    def __init__(self):
        ...
        self.pose_pub = rospy.Publisher('/graceful_mpc/desired_end_effector_pose', PoseStamped, queue_size=1)
        self.pose_sub = rospy.Subscriber('/graceful_mpc/set_marker_pose',PoseStamped,self.set_marker_pose)
